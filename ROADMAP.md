...
The goal is not to front-load a complete standard.
The goal is to build the smallest thing that can carry real knowledge pressure.
...
Federation is not an early requirement.
It should arrive only after:
