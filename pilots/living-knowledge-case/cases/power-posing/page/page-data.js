...
window.POWER_POSING_PAGE_DATA = {
  ...
  "description": "This page is a reader-facing release view over a small governed object set. It is not a complete archive and it is not the full live graph. It is a public snapshot of the current pilot reading. If you want the raw objects behind this page, follow the object links below.",
  "links": [
    {
      "label": "Snapshot v2",
  ...
  "statusCards": [
    {
      ...
      "summary": "The original strong-form claim says that brief expansive posture can change hormone levels and affect risk-taking behavior.",
      "badges": [
        "claim",
        "C-0001",
        "V-0001"
  ...
  "timeline": [
    ...
    {
      "year": "Current pilot verdict state",
      "title": "",
