#!/usr/bin/env python3
"""Validate direct support/challenge coverage on power-posing claim pages."""
...
def main() -> None:
    try:
        ...
        print("Claim page pressure coverage failed.", file=sys.stderr)
    ...
    print("Claim page pressure coverage passed.")
    print()
