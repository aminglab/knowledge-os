#!/usr/bin/env python3
"""Validate source-page layering for the h-pylori-ulcer pilot."""
...
def main() -> None:
    try:
        ...
        print("H. pylori source page layering failed.", file=sys.stderr)
    ...
    print("H. pylori source page layering passed.")
    print()
